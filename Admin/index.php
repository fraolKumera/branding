                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="alt-features-item">
                                <h2 class="alt-features-title font-alt"><B>Primary Colors</b></h2>
                                <div><img src="../assets/images/2/purple.PNG" alt="Portfolio Item" style="width:50%; height:50%"/></div>
                            </div>
                            <div class="alt-features-item">
                                <div><img src="../assets/images/2/blue.PNG" alt="Portfolio Item" style="width:50%; height:50%"/></div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="alt-features-item">
                                <h2 class="alt-features-title font-alt"><B>Color Result</b></h2>
